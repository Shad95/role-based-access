...
INSERT INTO USER (user_id,user_name,password,role) VALUES (
   1, 'Sam','{bcrypt}$2a$12$rVegTgBir76NCZ5okTyM9eX5URNZ.yUZ.aIt0NfddYi.MTnmYWUVa','admin');

INSERT INTO USER (user_id,user_name,password,role) VALUES (
   2, 'Gaby','{bcrypt}$2a$12$6q9fWaf9ItKPl/aqAoiUv.hRr8Php2VkOW9/QGsXPac8cYyFaoSXK','user'); 
   
INSERT INTO USER (user_id,user_name,password,role) VALUES (
   3, 'Tim','{bcrypt}$2a$12$tdGkr9Sg6PCmlCBWGTLN4eN/KtKerxqPC7c9MTzPmS66KOLRSATG6','user'); 
   
INSERT INTO USER (user_id,user_name,password,role) VALUES (
   4, 'Jim','{bcrypt}$2a$12$Y0b3e/HvQfwxZ7igI0IX0un1fZrflJhmD2zc6ZMXSR0UaOOtbCT12','admin');
